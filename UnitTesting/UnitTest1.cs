...
namespace UnitTest
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public async Task DeserializeIntoObject1() //Test, zda je objekt správně strukturován pro deserializaci (Weather)
        {
            // Arrange
            string ApiKey = "f4cdb9a4d3badec1ff1423c4a5fba527";
        ...
        [TestMethod]
        public async Task DeserializeIntoObject2() //Test, zda je objekt správně strukturován pro deserializaci (GooglePlaceAutoComplete)
        {
            // Arrange
        ...
        [TestMethod]
        public async Task DeserializeIntoObject3() //Test, zda je objekt správně strukturován pro deserializaci (GooglePlace)
        {
            // Arrange
