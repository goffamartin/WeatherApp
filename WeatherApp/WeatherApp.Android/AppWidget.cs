...
namespace WeatherApp.Droid
{
	...
	public class AppWidget : AppWidgetProvider
	{
		...
		{
			widgetView.SetTextViewText(Resource.Id.textWeather, "Na hovno");
			widgetView.SetTextViewText(Resource.Id.textPlace, "Praha");
			widgetView.SetTextViewText(Resource.Id.textTemperature, "21°C");
		}
